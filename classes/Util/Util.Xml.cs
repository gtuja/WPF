...
public class Xml
{
  ...
  */
  ...
  {
    public String strName;  /**< A String object holding the name of an attribute. */
    public String strValue; /**< A String object holding the value of an attribute. */
  ...
  */
    ...
    )
  {
    ...
    {
      lstException.Add(Util.Debug.strGetMethodNme() + " : " + e.ToString());
    }
    return lstReturn;
  }
